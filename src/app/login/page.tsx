  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#eef1ff] via-white to-[#f5f7ff] flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-[480px] h-[480px] bg-brand-primary/6 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -left-40 w-[480px] h-[480px] bg-brand-primary/4 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-white/80 p-8">
          <div className="mb-6">
            <h1 className="text-lg font-bold text-gray-900">Giriş Yap</h1>
            <p className="text-sm text-gray-400 mt-1">Hesabınıza erişmek için bilgilerinizi girin.</p>
          </div>
          ...
          <div className="mt-5 pt-5 border-t border-gray-100 text-center">
            <p className="text-xs text-gray-400">
              Hesabınız yok mu?{" "}
              <a href="/signup" className="text-brand-primary font-semibold hover:text-brand-hover transition-colors">
                Kayıt Ol
              </a>
            </p>
          </div>
